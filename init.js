...
module.exports.init = async function init() {
    try {
        ...
        const cors = function (req, res, next) {
            const whitelist = ['localhost:3000', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', '111.68.101.14:3000', 'http://111.68.101.14:3001', 'http://111.68.101.14', 'http://10.3.20.172', 'http://10.3.20.172:3000', 'http://10.3.20.172:3001',    'http://111.68.101.11', 'http://111.68.101.11:3000', 'http://111.68.101.11:3001'];
